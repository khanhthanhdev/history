      ...
      <Stack className="bg-white_A700 lg:h-[630px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] mx-[auto] w-[100%]">
        <Stack className="absolute bottom-[0] font-urbanist lg:h-[1173px] xl:h-[1342px] 2xl:h-[1509px] 3xl:h-[1811px] w-[100%]">
          ...
          >
            ...
            >
              <Row className="bg-gray_900_b1 lg:pr-[613px] xl:pr-[701px] 2xl:pr-[789px] 3xl:pr-[947px] w-[100%]">
                ...
                <Text className="font-medium lg:leading-[26px] xl:leading-[30px] 2xl:leading-[34px] 3xl:leading-[41px] lg:mt-[243px] xl:mt-[278px] 2xl:mt-[313px] 3xl:mt-[376px] lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-gray_300 w-[75%]">
                  From 939 to 1407, Vietnam in this period experienced many
                  feudal regimes: the Ngo Dynasty (939 – 965), the Dinh Dynasty
                  (968 – 980), the Former Le Dynasty (980 – 1009), the Ly
                  Dynasty (in Vietnamese). 1009 – 1225), Tran Dynasty (1226 –
                  1400) and Ho Dynasty (1400 – 1407).
                  <br />
          ...
          <Column
            ...
            style={{ backgroundImage: "url('images/img_decoration6_5.png')" }}
          >
            <Img
              src="images/img_blur_20.png"
...
export default IndependenceOnePage;
