      ...
      <Stack className="bg-white_A700 lg:h-[630px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] mx-[auto] w-[100%]">
        <Stack className="absolute font-urbanist lg:h-[630px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] w-[100%]">
            ...
            >
              <Row className="bg-gray_300_7e lg:pr-[625px] xl:pr-[715px] 2xl:pr-[804px] 3xl:pr-[965px] w-[100%]">
                ...
                <Text className="font-medium lg:leading-[26px] xl:leading-[30px] 2xl:leading-[34px] 3xl:leading-[41px] lg:mt-[243px] xl:mt-[278px] 2xl:mt-[312px] 3xl:mt-[375px] lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-gray_900 w-[75%]">
                  Prehistory of Vietnam introduces vestiges reflecting the early
                  appearance of people in Vietnam and relics, relics, and
                  culture reflecting human activities from the Early Stone Age.
                  from the old to the Late Neolithic in Vietnam from the
                  mountains, midlands, plains, coastal areas and islands; The
                  exchange with cultures in the region for development, step by
                  step creates an important infrastructure premise to bring
          ...
          <Column
            ...
            style={{ backgroundImage: "url('images/img_decoration2_13.png')" }}
          >
            <Img
              src="images/img_blur_42.png"
              className="lg:h-[173px] xl:h-[198px] 2xl:h-[223px] 3xl:h-[267px] rounded-radius240 w-[100%]"
              alt="Blur"
            />
          </Column>
        </Stack>
        <Stack className="absolute bottom-[0] font-svngratelosdisplay lg:h-[1173px] xl:h-[1342px] 2xl:h-[1509px] 3xl:h-[1811px] right-[0] w-[50%]">
          <Img
...
export default PrehistoricOnePage;
