      ...
      <Stack className="bg-white_A700 lg:h-[630px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] mx-[auto] w-[100%]">
        <Stack className="absolute bottom-[0] font-urbanist lg:h-[1173px] xl:h-[1342px] 2xl:h-[1509px] 3xl:h-[1811px] w-[100%]">
          ...
          >
            ...
            >
              <Row className="bg-gray_300_7e lg:pr-[625px] xl:pr-[715px] 2xl:pr-[804px] 3xl:pr-[965px] w-[100%]">
                ...
                <Text className="font-medium lg:leading-[26px] xl:leading-[30px] 2xl:leading-[34px] 3xl:leading-[41px] lg:mt-[243px] xl:mt-[278px] 2xl:mt-[313px] 3xl:mt-[376px] lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-gray_900 w-[75%]">
                  ...
                  <br />
                  During this period, France annexed Vietnam, Cambodia and Laos.
                  Losing sovereignty, Vietnam was divided into 3 separate
                  countries with three separate administrative structures: the
                  colonial land of Cochinchina and the protectorates of North
                  and Central America.
                </Text>
              </Row>
            </Column>
          ...
          <Column
            ...
            style={{
              backgroundImage: "url('images/img_decoration2_296X480.png')",
            }}
          >
            <Img
              src="images/img_blur_4.png"
          ...
          <Stack className="absolute font-svngratelosdisplay lg:h-[1173px] xl:h-[1342px] 2xl:h-[1509px] 3xl:h-[1811px] right-[0] w-[50%]">
            <Img
              src="images/img_image_1080X952.png"
...
export default FrenchDominationOnePage;
