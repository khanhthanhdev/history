...
const ChineseDominationFourPage = () => {
  return (
    <>
      <Stack className="bg-white_A700 font-svngratelosdisplay lg:h-[630px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] mx-[auto] w-[100%]">
        <Stack className="absolute lg:h-[630px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] w-[100%]">
              ...
              <Row className="bg-gray_300_7e items-center lg:pr-[23px] xl:pr-[26px] 2xl:pr-[30px] 3xl:pr-[36px] w-[100%]">
                ...
                <Column className="w-[46%]">
                  ...
                  <Column className="lg:ml-[51px] xl:ml-[58px] 2xl:ml-[66px] 3xl:ml-[79px] lg:mt-[63px] xl:mt-[72px] 2xl:mt-[81px] 3xl:mt-[97px] w-[90%]">
                    ...
                    <Text className="font-medium font-urbanist lg:leading-[26px] xl:leading-[30px] 2xl:leading-[34px] 3xl:leading-[41px] lg:mt-[33px] xl:mt-[38px] 2xl:mt-[43px] 3xl:mt-[52px] lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-gray_900 w-[90%]">
                    ...
                    <Row className="font-svngratelosdisplay items-center justify-end ml-[auto] lg:mt-[105px] xl:mt-[120px] 2xl:mt-[135px] 3xl:mt-[162px] w-[43%]">
          ...
          <Column
            ...
            style={{ backgroundImage: "url('images/img_decoration2_8.png')" }}
          >
            <Img
              src="images/img_blur_27.png"
...
export default ChineseDominationFourPage;
