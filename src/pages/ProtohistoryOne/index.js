      ...
      <Stack className="bg-white_A700 lg:h-[630px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] mx-[auto] w-[100%]">
        <Stack className="absolute bottom-[0] font-urbanist lg:h-[1173px] xl:h-[1342px] 2xl:h-[1509px] 3xl:h-[1811px] w-[100%]">
          ...
          >
            ...
            >
              <Row className="bg-gray_900_b1 lg:pr-[613px] xl:pr-[701px] 2xl:pr-[789px] 3xl:pr-[947px] w-[100%]">
                ...
                <Text className="font-medium lg:leading-[26px] xl:leading-[30px] 2xl:leading-[34px] 3xl:leading-[41px] lg:mt-[243px] xl:mt-[278px] 2xl:mt-[312px] 3xl:mt-[375px] lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-gray_300 w-[75%]">
                  After the Paleolithic, gone for a long time to about 4000
                  years ago today. In the Southeast, a new class of inhabitants
                  appeared. They belonged to the Dong Nai culture of the Metal
                  Age (early brass and iron); living in different ecological sub
                  - regions.
                  <br />
                  From the Red River basin to the Dong Nai river basin. During
                  this period in Vietnam, there were three major cultural
                  centers, namely Dong Son (Northern region), Sa Huynh (Central
                  region) and Dong Nai (Southern region).
                </Text>
              </Row>
            </Column>
          </Column>
          ...
          <Column
            ...
            style={{ backgroundImage: "url('images/img_decoration6_13.png')" }}
          >
            <Img
              src="images/img_blur_41.png"
...
export default ProtohistoryOnePage;
