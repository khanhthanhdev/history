...
const FrenchDominationFourPage = () => {
  return (
    <>
      <Stack className="bg-white_A700 font-svngratelosdisplay lg:h-[630px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] mx-[auto] w-[100%]">
        <Stack className="absolute lg:h-[630px] xl:h-[721px] 2xl:h-[811px] 3xl:h-[973px] w-[100%]">
            ...
            >
              <Row className="bg-gray_300_7e items-center lg:pr-[23px] xl:pr-[26px] 2xl:pr-[30px] 3xl:pr-[36px] w-[100%]">
                ...
                <Column className="w-[74%]">
                  ...
                  <Text className="font-medium font-urbanist lg:leading-[26px] xl:leading-[30px] 2xl:leading-[34px] 3xl:leading-[41px] lg:mr-[256px] xl:mr-[293px] 2xl:mr-[330px] 3xl:mr-[396px] lg:mt-[190px] xl:mt-[217px] 2xl:mt-[244px] 3xl:mt-[293px] lg:text-[18px] xl:text-[21px] 2xl:text-[24px] 3xl:text-[28px] text-gray_900 w-[69%]">
                  ...
                  <Row className="font-svngratelosdisplay items-center justify-end ml-[auto] lg:mt-[100px] xl:mt-[115px] 2xl:mt-[129px] 3xl:mt-[155px] w-[24%]">
          ...
          <Column
            ...
            style={{ backgroundImage: "url('images/img_decoration2_1.png')" }}
          >
            <Img
              src="images/img_blur_6.png"
              className="lg:h-[173px] xl:h-[198px] 2xl:h-[223px] 3xl:h-[267px] rounded-radius240 w-[100%]"
              alt="Blur"
            />
          </Column>
        </Stack>
        <Text className="absolute font-normal inset-x-[0] mx-[auto] not-italic 2xl:text-[108px] 3xl:text-[129px] lg:text-[84px] xl:text-[96px] text-red_700 text-shadow-ts3 top-[19%] xl:tracking-ls3 lg:tracking-ls3 2xl:tracking-ls4 3xl:tracking-ls5 uppercase w-[max-content]">
          FRENCH DOMINATION
        </Text>
      </Stack>
    </>
...
export default FrenchDominationFourPage;
